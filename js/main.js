...
$(document).ready(function () {
    ...
    // ⚡ Bolt: Use Fisher-Yates algorithm for in-place array shuffling instead of map().sort().map()
    // This avoids O(n log n) overhead, intermediate array allocations, and statistical bias.
