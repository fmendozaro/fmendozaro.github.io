...
$(document).ready(function () {
    ...
    // ⚡ Bolt: Use Fisher-Yates algorithm for O(n) in-place array shuffling instead of
    // O(n log n) map().sort().map() chain to avoid overhead and intermediate array allocations.
